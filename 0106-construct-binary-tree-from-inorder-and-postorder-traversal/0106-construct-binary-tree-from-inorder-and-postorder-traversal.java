...
class Solution {
    ...
    public TreeNode buildTree(int[] postorder,int postStart,int postEnd,int[] inorder,int inStart,int inEnd,Map<Integer,Integer>inMap){
        ...
        root.left=buildTree(postorder,postEnd+numsleft-1,postEnd,inorder,inStart,inRoot-1,inMap);
        root.right=buildTree(postorder,postStart-1,postEnd+numsleft,inorder,inRoot+1,inEnd,inMap);
        return root;
    }
    }
